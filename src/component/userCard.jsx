...
export default function UserCard(props) {
    return (
        <>
            <div className="flex h-full flex-col md:items-center sm:items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <div className="relative overflow-hidden h-full p-4" style={{ "width": "-webkit-fill-available" }}>
                ...
                <div className='md:h-full sm:h-auto w-full'>
                    <div className="flex md:h-full sm:h-auto xl:w-[230px] lg:w-[200px] md:w-[150px] sm:w-full flex-col p-4 leading-normal md:justify-between sm:justify-start">
